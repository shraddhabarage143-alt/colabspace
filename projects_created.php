...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    switch ($action) {
        case 'fetch_project_data':
            fetchProjectData($conn, $_POST['project_id']);
            break;
        case 'get_project_info':
            getProjectInfo($conn, $_POST['project_id']);
            break;
        case 'add_member':
        ...
        case 'update_member':
            ...
            break;
        case 'delete_member':
            deleteMember($conn, $_POST['joined_id']);
            break;
        case 'add_idea':
            addIdea($conn, $_POST);
            break;
...
<body>
    ...
    <script>
        ...
        async function loadProjectData() {
            const result = await apiCall('fetch_project_data', { project_id: projectId });
        ...
        async function addMember(e) {
            ...
            const result = await apiCall('add_member', data);
